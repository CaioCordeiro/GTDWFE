...
file_other<-paste0("E:\\Research\\All ML works\\Extracted Feature_revised\\CD-HIT Resistance Genes\\Merged_BL\\Merged_BL_Nature\\pse_vib_ent\\BL_merged_feature_under11",".csv")
  ...
  mymodel2
  conf2_1<-confusionMatrix(predict(mymodel2, test), test$Output)
  conf2_1
  conf2_1<-confusionMatrix(predict(mymodel2, test), test$Output)
...
#file_under<-paste0("E:\\Research\\GT\\pseudovibenterononarwith histone\\svm_results\\Under_statistics_sep",sval, ".txt")
